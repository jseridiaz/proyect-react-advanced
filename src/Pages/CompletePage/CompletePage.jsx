...
const STATUS_CONTENT_MAP = {
   succeeded: {
      text: "The Payment has been done succeeded",
      iconColor: "#30B130",
      icon: SuccessIcon,
   },
   processing: {
...
function CompletePage() {
   ...
   return (
      <DivStatus className='payment-status'>
         <div
            id='status-icon'
         ...
         {intentId && (
            <div id='details-table'>
               <table>
                  <tbody>
                     <tr id='first-table'>
                        <td className='TableLabel'>Order Reference:</td>
...
export const ElementCompletePage = () => {
   const { userSecret } = location.state
